module.exports = function () {
    Object.defineProperties(this, {
        ...
        _iterator: {
            ...
            enumerable = false,
            configurable = false,
            get: function () { return _iterator && _iterator.data; }
        }
    })
}
...
//todo: this will have to check if size is exactly 1 and set everything to undefined
//check for edge cases such as if node to remove is head or tail 
